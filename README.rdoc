...
application development. Because development was focused on doing things
the WRONG way, even unrelated good programming practices are skipped,
including usage of Rails excellent testing facilities.

IMPORTANT: Even though I have spent some time trying to make the
application look good enough, it is EXTREMELY vulnerable as is, and should
